    ...
    <div class="min-h-screen lg:flex">
        <aside class="fixed inset-y-0 left-0 z-20 hidden w-[254px] bg-white lg:block">
            ...
            <nav class="mt-[62px] space-y-[9px] px-4 text-[14px] font-semibold text-[#41546a]">
                ...
                <a href="{{ $url }}" class="flex h-[48px] items-center gap-[17px] rounded-[16px] px-[18px] {{ $label === 'Program Penyaluran' ? 'bg-[#f4f8f6] font-black text-[#0b751f] shadow-[inset_4px_0_0_#0b751f]' : '' }}">
        ...
        <main class="min-h-screen flex-1 lg:ml-[254px]">
            <header class="flex h-[64px] items-center justify-between bg-white px-6 lg:px-[34px]">
                <form action="{{ route('program-penyaluran.index') }}" method="GET" class="ml-0 flex h-[36px] w-[318px] max-w-full items-center gap-3 rounded-full bg-[#eef2f0] px-4">
                    <svg class="h-5 w-5 text-[#909a94]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <div class="hidden items-center gap-[26px] md:flex">
                    <svg class="h-5 w-5 text-[#626b66]" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M10 18a2.5 2.5 0 0 0 2.4-2H7.6A2.5 2.5 0 0 0 10 18ZM4 14h12l-1.4-2.3V8a4.6 4.6 0 1 0-9.2 0v3.7L4 14Z" />
                    </svg>
                    <svg class="h-6 w-6 text-[#626b66]" fill="currentColor" viewBox="0 0 20 20">
                        <path d="m10 1 1.5 2.1 2.6-.4.9 2.5 2.3 1.3-1.1 2.4.8 2.6-2.2 1.5-.7 2.6-2.6-.2L10 17.5l-1.5-2.1-2.6.2-.7-2.6L3 11.5l.8-2.6-1.1-2.4L5 5.2l.9-2.5 2.6.4L10 1Zm0 6a3 3 0 1 0 0 6 3 3 0 0 0 0-6Z" />
                    </svg>
                    ...
                    <article class="min-h-[266px] rounded-[13px] bg-white px-[24px] py-[24px] shadow-sm ring-1 ring-[#e3ebe6]">
                        <div class="flex items-start justify-between">
                            <span class="flex h-[48px] w-[48px] items-center justify-center rounded-[15px] bg-[#e8eeeb] text-[#0b751f]">
                                ...
                                <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M8 3h4v4h4v4h-4v4H8v-4H4V7h4V3Z" />
                                </svg>
                                @elseif (($program->icon ?? '') === 'shop')
                                <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M3 5h14l-1 4H4L3 5Zm1 5h12v6H4v-6Zm2 1v3h3v-3H6Z" />
                                </svg>
                                @elseif (($program->icon ?? '') === 'mosque')
                                <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M10 2c2 1.2 3 2.8 3 5v2h3v8H4V9h3V7c0-2.2 1-3.8 3-5Zm0 9a2 2 0 0 0-2 2v4h4v-4a2 2 0 0 0-2-2Z" />
                                </svg>
                                @else
                                <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="m10 3 8 4-8 4-8-4 8-4Zm-5 7.2 5 2.5 5-2.5V14l-5 2.5L5 14v-3.8Z" />
                                </svg>
                                @endif
                            </span>
