    ...
    <main class="min-h-screen flex-1 lg:ml-[254px]">
        <header class="flex h-[76px] items-center justify-between bg-white px-6 lg:px-12">
            <a href="{{ route('mustahik.index') }}" class="inline-flex items-center gap-3 text-base font-semibold text-[#6b766e]">
                <svg class="h-6 w-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M19 12H5m6-7-7 7 7 7"/></svg>
                Kembali ke Database
            </a>
            <div class="hidden items-center gap-6 md:flex">
                <div class="relative">
                    <svg class="h-6 w-6 text-[#5f6e66]" fill="currentColor" viewBox="0 0 20 20"><path d="M10 18a2.5 2.5 0 0 0 2.4-2H7.6A2.5 2.5 0 0 0 10 18ZM4 14h12l-1.4-2.3V8a4.6 4.6 0 1 0-9.2 0v3.7L4 14Z"/></svg>
        ...
        <section class="px-6 py-10 lg:px-12">
            ...
            <form action="{{ route('mustahik.store') }}" method="POST" enctype="multipart/form-data" class="mt-10 max-w-[930px] rounded-2xl bg-white px-10 py-11 shadow-sm ring-1 ring-[#e8eeeb]">
                ...
                <section>
                    <div class="mb-8 flex items-center gap-4">
                        <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-[#e8f5ec] text-[#0b751f]">
                            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20"><path d="M7 2h6v3h3v13H4V5h3V2Zm2 3h2V4H9v1Zm-1 6a2 2 0 1 0 4 0 2 2 0 0 0-4 0Zm-2 5h8c-.4-2-1.8-3-4-3s-3.6 1-4 3Z"/></svg>
                        </span>
                ...
                <section class="mt-12">
                    <div class="mb-8 flex items-center gap-4">
                        <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-[#e8f5ec] text-[#0b751f]">
                            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2 3 11h5v6h8v-6h1L10 2Zm3 11a2 2 0 1 1 0 4 2 2 0 0 1 0-4Z"/></svg>
                        </span>
                ...
                <section class="mt-12">
                    <div class="mb-8 flex items-center gap-4">
                        <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-[#e8f5ec] text-[#0b751f]">
                            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2a6 6 0 0 0-6 6c0 4.5 6 10 6 10s6-5.5 6-10a6 6 0 0 0-6-6Zm0 8.3A2.3 2.3 0 1 1 10 5.7a2.3 2.3 0 0 1 0 4.6Z"/></svg>
                        </span>
