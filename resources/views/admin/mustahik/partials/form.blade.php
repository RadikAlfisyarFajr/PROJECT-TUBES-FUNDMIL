                ...
                <form action="{{ $action }}" method="POST" class="mt-[38px] max-w-[1040px] rounded-[15px] bg-white px-[44px] py-[42px] shadow-sm ring-1 ring-[#e6ece9]">
                    ...
                    <section>
                        ...
                        <div class="mt-[27px] grid gap-[24px] md:grid-cols-2">
                            ...
                            <label>
                                ...
                                <input
                                    name="no_kk"
                                    value="{{ old('no_kk', $mustahik->no_kk ?? '') }}"
                                    class="mt-[10px] h-[48px] w-full rounded-[11px] bg-[#e5eae7] px-4 text-sm outline-none focus:bg-white focus:ring-2 focus:ring-[#0b751f]"
                            ...
                            <div class="grid gap-[24px] md:grid-cols-2">
                                <label>
                                    ...
                                    <input
                                        name="tempat_lahir"
                                        value="{{ old('tempat_lahir', $mustahik->tempat_lahir ?? '') }}"
                                        class="mt-[10px] h-[48px] w-full rounded-[11px] bg-[#e5eae7] px-4 text-sm outline-none focus:bg-white focus:ring-2 focus:ring-[#0b751f]"
                                ...
                                <label>
                                    ...
                                    <input
                                        type="date"
                                        name="tanggal_lahir"
                                        value="{{ old('tanggal_lahir', optional($mustahik->tanggal_lahir)->format('Y-m-d')) }}"
                                        class="mt-[10px] h-[48px] w-full rounded-[11px] bg-[#e5eae7] px-4 text-sm outline-none focus:bg-white focus:ring-2 focus:ring-[#0b751f]">
                                </label>
                            </div>
                            <div>
                                ...
                                <div class="mt-[10px] grid grid-cols-2 gap-4">
                                    <button type="button" data-jenis-kelamin="laki-laki" class="h-[48px] rounded-[11px] border-2 border-[#0b751f] bg-white text-sm font-bold">Laki-laki</button>
                                    <button type="button" data-jenis-kelamin="perempuan" class="h-[48px] rounded-[11px] bg-[#e5eae7] text-sm font-bold">Perempuan</button>
                                    <input type="hidden" name="jenis_kelamin" id="jenis_kelamin" value="{{ old('jenis_kelamin', $mustahik->jenis_kelamin ?? '') }}">
                                </div>
                            </div>
                            <label>
                    ...
                    <section class="mt-[42px]">
                        <h2 class="flex items-center gap-3 text-[20px] font-black">
                            <span class="grid h-[30px] w-[30px] place-items-center rounded-[8px] bg-green-50 text-[#0b751f]">
                                <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M4 4h12v12H4V4Zm3 3h6v2H7V7Zm0 4h6v2H7v-2Z" />
                                </svg>
                            </span>
                            Foto Dokumen
                        </h2>
                        <div class="mt-[24px] grid gap-[30px] md:grid-cols-2">
                            <div class="grid h-[140px] place-items-center rounded-[12px] border-2 border-dashed border-[#c8d6ce] bg-[#fbfcfb] text-center text-[#6c756f]">
                                <div>
                                    <svg class="mx-auto h-8 w-8" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M4 5h3l1-2h4l1 2h3v11H4V5Zm6 3a3 3 0 1 0 0 6 3 3 0 0 0 0-6Z" />
                                    </svg>
                            ...
                            <div class="grid h-[140px] place-items-center rounded-[12px] border-2 border-dashed border-[#c8d6ce] bg-[#fbfcfb] text-center text-[#6c756f]">
                                <div>
                                    <svg class="mx-auto h-8 w-8" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M4 3h12v14H4V3Zm3 4h6V5H7v2Zm0 4h6V9H7v2Zm0 4h4v-2H7v2Z" />
                                    </svg>
