...
<head>
    ...
    <title>Edit Nishab | Super Admin</title>
    ...
    <div class="admin-layout">
        ...
        <main class="admin-page-content">
            <header class="admin-page-topbar">
                <div>
                    <h1 class="admin-page-title">Edit Nishab</h1>
                    <p class="admin-page-desc">{{ $nishab->tanggal_berlaku?->format('d M Y') }}</p>
                </div>
            ...
            <div class="admin-content-wrap">
                ...
                <section class="admin-panel">
                    <form method="POST" action="{{ route('superadmin.nishab.update', $nishab) }}" class="super-form-grid">
                        @csrf
                        @method('PUT')
                        @include('superadmin.nishab.nishab-form')
